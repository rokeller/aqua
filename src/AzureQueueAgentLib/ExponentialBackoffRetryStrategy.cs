...
namespace Aqua
{
    ...
    /// </summary>
    public sealed class ExponentialBackoffRetryStrategy : BackoffRetryStrategyBase
    {
        #region C'tors

        /// <summary>
        /// Initializes a new instance of ExponentialBackoffRetryStrategy using the given maximum number of retries
        ...
        /// </param>
        public ExponentialBackoffRetryStrategy(int retryCount, TimeSpan baseWaitTime)
