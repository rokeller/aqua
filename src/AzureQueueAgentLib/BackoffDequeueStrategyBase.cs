...
namespace Aqua
{
    ...
    /// </summary>
    public abstract class BackoffDequeueStrategyBase : IDequeStrategy
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of BackoffDequeueStrategyBase using the given maximum retry count and
        ...
        /// </param>
        protected BackoffDequeueStrategyBase(int retryCount, TimeSpan[] waitTimes)
        {
            if (null == waitTimes)
            {
